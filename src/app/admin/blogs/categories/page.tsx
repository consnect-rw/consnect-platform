     ...
     return (
          <div className="w-full flex flex-col gap-4">
               <div className="w-full flex flex-col gap-2 bg-white rounded-xl p-4">
                    <h1 className="text-3xl font-extrabold text-gray-900">Blog Categories</h1>
                    <div className="w-full flex items-center justify-between">
                         <span className="font-bold text-lg text-gray-600">{totalCategories} categories</span>
                         <CategoryFormToggleBtn categoryType="BLOG" name="Category" icon={<Plus className="w-5 h-5" />} className={"py-2 px-4 rounded-lg font-bold text-white bg-yellow-800 flex items-center gap-1 cursor-pointer"} title="New Blog Category" />
                    </div>
               </div>
