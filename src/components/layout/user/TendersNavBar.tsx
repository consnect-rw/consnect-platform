...
import { FileText, Plus, Globe, Send, ChevronDown, ChevronsDown } from 'lucide-react';
...
const TenderLinks = [
  ...
  { name: "ReceivedApplications", href: "/dashboard/tenders/received", icon: ChevronsDown },
  { name: "New Tender", href: "/dashboard/tenders/form", icon: Plus },
  { name: "Browse Tenders", href: "/dashboard/tenders/posted", icon: Globe },
  { name: "Sent Applications", href: "/dashboard/tenders/sent-applications", icon: Send },
];

export default function UserTendersNavBar() {
      ...
      <div className="md:hidden w-full">
        ...
        >
          <div className="flex items-center gap-3">
            {(() => {
              const activeItem = TenderLinks.find(link => link.href === pathname);
